...
public class List12Tester extends TestCase
{
  ...
  public void testAddGet()
  {
    ...
    for(int i=0; i<1000; i++)
    {
      assertEquals(intList.get(i),new Integer(i));
    }
  }
  ...
  public void testGet()
  {
    ...
    for(int i=0; i<1000; i++)
    {
      assertEquals(intList.get(i).intValue(), i);
    }
  }
  ...
  public void testIndexOf()
  {
    ...
    assertEquals(strList.indexOf("A"), -1);

    //Add "A"
    //indexOf("A") should return 0.
    strList.add(0, "A");
    assertEquals(strList.indexOf("A"), 0);

    //Add "B"
    //indexOf("B") should return 1.
    strList.add(1, "B");
    assertEquals(strList.indexOf("B"), 1);
    ...
    strList.set(0, "C");
    assertEquals(strList.indexOf("A"), 2);

    //"D" not added. Should return -1.
    assertEquals(strList.indexOf("D"), -1);
  }
