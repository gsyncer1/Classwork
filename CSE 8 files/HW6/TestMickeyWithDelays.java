...
public class TestMickeyWithDelays extends DrawingPanel
{
  private Graphics g;

  public static void main( String[] args )
  {
    new TestMickeyWithDelays( 500, 500 );
  }

  public TestMickeyWithDelays( int width, int height )
  {
    super( width, height );
  ...
  public void makeMickey()
  {
    ...
    p1 = new Point( this.getWidth()/2, this.getHeight()/2 );
	...
	this.sleep( 500 );
      ...
      g.drawString( s, c4.getCenter().getX() - xOffset,
